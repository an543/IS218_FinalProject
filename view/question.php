    ...
    <section>
        <div class="formContainer">
            <div class="formBox">
                ...
                <h2 class='questionHeading'>Body:&nbsp;</h2><p class='questionContent'><?php echo $question->getBody(); ?></p><br>
				<h2 class='questionHeading'>Skills:&nbsp;</h2><p class='questionContent'><?php echo $question->getSkills(); ?></p><br><br>
                <?php $answerCounter = 1; ?>
